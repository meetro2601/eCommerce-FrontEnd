                        ...
                        <div className="main-content">
                            <div className="product product-single row">
                                            ...
                                            <div className="swiper-wrapper row cols-1 gutter-no">
                                                <div className="swiper-slide">
                                                    <figure className="product-image">
                                                        <img src={Images.ProductDetailImage}
                                ...
                                <div className="col-md-6 sticky-sidebar-wrapper mb-4 mb-md-6">
                                    <div className="product-details sticky-sidebar" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div className="product-price"><ins className="new-price">$780.00</ins></div>
                            ...
                            <div className="tab tab-nav-boxed tab-nav-underline product-tabs mt-3">
                                <ul className="nav nav-tabs" role="tablist">
                                    ...
                                    <li className="nav-item">
                                        <a href="#product-tab-reviews" className="nav-link">Reviews</a>
                                    </li>
                                </ul>
                                ...
                                <div className="swiper-container swiper-theme" data-swiper-options="{
                                    ...
                                    <div className="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                        <div className="swiper-slide product">
                                            <figure className="product-media">
                                                <a href="product-default.html">
                                                    <img src={Images.ProductImage5} alt="Product"
                                        ...
                                        <div className="swiper-slide product">
                                            <figure className="product-media">
                                                <a href="product-default.html">
                                                    <img src={Images.ProductImage6} alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div className="product-action-vertical">
                                                    <a href="#" className="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div className="product-details">
                                                ...
                                                <div className="product-pa-wrapper">
                                                    <div className="product-price">
                                                        <ins className="new-price">$263.00</ins><del
                                                            className="old-price">$300.00</del>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="swiper-slide product">
                                            <figure className="product-media">
                                                <a href="product-default.html">
                                                    <img src={Images.ProductImage71} alt="Product"
                                                        width="300" height="338" />
                                                    <img src={Images.ProductImage72} alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div className="product-action-vertical">
                                                    <a href="#" className="btn-product-icon btn-cart w-icon-cart"
                                            ...
                                            <div className="product-details">
                                                <h4 className="product-name"><a href="product-default.html">Phone Charge
                                                    Pad</a>
                                                </h4>
                                                <div className="ratings-container">
                                                    <div className="ratings-full">
                                        ...
                                        <div className="swiper-slide product">
                                            <figure className="product-media">
                                                <a href="product-default.html">
                                                    <img src={Images.ProductImage2} alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div className="product-action-vertical">
                                                    <a href="#" className="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div className="sticky-sidebar">
                                    ...
                                    <div className="widget widget-banner mb-9">
                                        <div className="banner banner-fixed br-sm">
                                            <figure>
                                                <img src={Images.Banner3} alt="Banner" width="266"
