              ...
              <div className="row gutter-lg">
                <div className=" post-single-content">
                    ...
                    <div className="post-details">
                      ...
                      <div className="post-content">
                        <p>
                          ...
                          nibh. Suspendisse potenti. Sed egstas, ant at
                          vulputate volutpat, uctus metus libero eu augue, vitae
                          luctus metus libero eu augue.{" "}
                        </p>
                        <p>
                          Morbi purus libero, faucibus adi piscing, com modo
                          quis, gravida iest. Sed lectus. Praesent elementum
                          ...
                          nisl. pede arcu, dapibus eu, fermen tum et, dapibus
                          sed, urna.{" "}
                          <a href="/">Morbi interdum mollis sapien.</a>
                          Sed ac risus. Pha sellus lacinia, magna a laoreet,
                          lect us arcu pulvinar risus, vitae fac ilisis libero
                          dolor a purus.
                        </p>
                      </div>
                    </div>
                  ...
                  <p className="mb-2">
                    ...
                    felis. Vestibulum volutpat, lacus a ultric sagittis, mi
                    neque euismod duin.
                  </p>
                  ...
                  <p>
                    Nibh ipsum consequat nisl vel. Non arcu risus quis varius
                    quam quisque id diam vel. Eu turpis egestas pharetra.
                  </p>
                  ...
                  <div className="post-navigation">
                    <div className="nav nav-prev">
                      <a href="/" className="align-items-start text-left">
                        <span>
                          <i className="w-icon-long-arrow-left"></i>previous
                          post
                        </span>
                    ...
                    <div className="nav nav-next">
                      <a href="/" className="align-items-end text-right">
                        <span>
                          next post<i className="w-icon-long-arrow-right"></i>
                        </span>
                        <span className="nav-content mb-0 text-normal">
                      ...
                      <div className="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-xs-2 cols-1">
                        ...
                        <div className="swiper-slide post post-grid">
                          ...
                          <div className="post-details text-center">
                            ...
                            <h4 className="post-title mb-3">
                              <a href="post-single.html">
                                We want to be different and fashion gives to me
                                that outlet
                              </a>
                            </h4>
                            <a
                    ...
                    <li className="comment">
                      <div className="comment-body">
                        <div className="comment-content">
                          ...
                          >
                            Reply<i className="w-icon-long-arrow-right"></i>
                          </a>
                        </div>
                      </div>
                    </li>
                  ...
                  <form className="reply-section pb-4">
                    ...
                    <button className="btn btn-dark btn-rounded btn-icon-right btn-comment">
                      Post Comment<i className="w-icon-long-arrow-right"></i>
                    </button>
                  </form>
                </div>
              </div>
