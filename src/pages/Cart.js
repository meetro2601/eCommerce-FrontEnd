                                        ...
                                        <td className="product-thumbnail">
                                            <div className="p-relative">
                                                <a href="product-default.html">
                                                    <figure>
                                                        <img src={Images.Shop12} alt="product"
                                    ...
                                    <tr>
                                        <td className="product-thumbnail">
                                            <div className="p-relative">
                                                <a href="product-default.html">
                                                    <figure>
                                                        <img src={Images.Shop13} alt="product"
                                                            width="300" height="338" />
                                                    </figure>
                                                </a>
                                                <button className="btn btn-close"><i className="fas fa-times"></i></button>
                                            </div>
                                        </td>
                                        <td className="product-name">
                                            <a href="product-default.html">
                                ...
                                <div className="cart-summary mb-4">
                                    ...
                                    <ul className="shipping-methods mb-2">
                                        ...
                                        <li>
                                            <div className="custom-radio">
                                                <input type="radio" id="free-shipping" className="custom-control-input"
                                                    name="shipping" />
                                        ...
                                        <li>
                                            <div className="custom-radio">
                                                <input type="radio" id="local-pickup" className="custom-control-input"
                                                    name="shipping" />
                                        ...
                                        <li>
                                            <div className="custom-radio">
                                                <input type="radio" id="flat-rate" className="custom-control-input"
                                                    name="shipping" />
                                    ...
                                    <div className="shipping-calculator">
                                        ...
                                        <form className="shipping-calculator-form">
                                            <div className="form-group">
                                                <div className="select-box">
                                                    <select name="country" defaultValue='United States
                                                            (US)' className="form-control form-control-md">
                                            ...
                                            <div className="form-group">
                                                <div className="select-box">
                                                    <select name="state" defaultValue='California' className="form-control form-control-md">
